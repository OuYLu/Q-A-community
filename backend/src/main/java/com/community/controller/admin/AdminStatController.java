...
public class AdminStatController {
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard content trend")
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard governance trend")
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard user activity trend")
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard pending audits")
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard pending reports")
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard hot tags")
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard hot topics")
    ...
    @PreAuthorize("hasAnyAuthority('menu:dashboard','dashboard:view','op:dashboard:view')")
    @Operation(summary = "Dashboard new user tags")
